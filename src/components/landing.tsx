...
const plans = [
  {
    ...
    price: 'R$ 100',
    period: '/mês',
    features: ['30 adaptações/mês', '3 adaptações teste incluídas', 'Adaptação pelo WhatsApp', 'Todos os perfis de acessibilidade', 'Upload de PDF e DOCX', 'Exportação em PDF', 'Suporte por email'],
    highlight: false,
    cta: 'Testar Grátis',
    href: APP_SIGNUP_URL,
  },
  {
    ...
    price: 'R$ 1.250',
    period: '/mês',
    features: ['250 adaptações/mês', '5 adaptações teste incluídas', 'Adaptação pelo WhatsApp', 'Todos os 9 perfis de acessibilidade', 'Upload de PDF, DOCX e imagens', 'Multi-tenant com gestão de professores', 'Dashboard de métricas', 'Suporte prioritário', 'Todos os tipos de adaptação'],
    highlight: true,
